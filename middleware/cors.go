...
func CORSMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Writer.Header().Set("Access-Control-Allow-Headers", "Content-Type,Version,Device,Unique-Device,Drives,Web-Token,Device-Model,screen-size,Channel-Name,,Version-Name,Origin-Id,IDFA")
